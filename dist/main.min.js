...
;(function(){
    $('.table__reviews--text--cross').click(function(e){
        window.location.href='./reviewremoved.html';
    });
    // window.location.href='./reviews.html';
})();;(function(){
...
showText('.payment__open--desc', '.payment__opac--mobile');;(function(){
